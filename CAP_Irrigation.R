...
#Percentage of correct classifications was 79.16667 
#Significance of this percentage was 0.00010001 
#Overall classification success (m=24) : 79.1666666666667 percent
#Control (n=60) correct: 81.6666666666667 percent
#Rainout (n=60) correct: 76.6666666666667 percent
...
plot(aoa.cap.bulk.irri$x[, 1:2], xlab = aoa.cap1.bulk, ylab = aoa.cap2.bulk, pch = c(16, 17),
     col = c("#009E73","#FF618C","#E69F00", "#009E73", "#FF618C", "#E69F00")[aoa.meta.bulk.ed$x])
ordiellipse(aoa.cap.bulk.irri$x[, 1:2], groups = aoa.meta.bulk.ed$x, draw = "polygon", 
...
aoa.cap.irri.plot <- ggplot(as.data.frame(aoa.cap.bulk.irri$x), aes(x = aoa.cap.bulk.irri$x[,1], y = aoa.cap.bulk.irri$x[,2])) +
